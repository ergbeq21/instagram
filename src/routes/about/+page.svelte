				...
				<ul class="flex items-center gap-6 text-sm">
					...
					<li class="relative group">
						...
						<ul class="absolute left-0 mt-0.1 w-40 rounded shadow-lg hidden group-hover:block">
							<li><a href="/admin/users" class=" bg-white text-gray-500  block px-4 py-2 transition hover:text-gray-500/75 ">Users</a></li>
							<li><a href="/admin/api/article" class=" bg-white text-gray-500  block px-4 py-2 transition hover:text-gray-500/75 ">Articles</a></li>
							<li><a href="/admin/comments" class="bg-white text-gray-500  block px-4 py-2 transition hover:text-gray-500/75">Comments</a></li>
						</ul>
					</li>
