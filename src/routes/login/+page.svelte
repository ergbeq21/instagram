	  ...
	  <div class="flex flex-1 items-center justify-end md:justify-between">
		<nav aria-label="Global" class="hidden md:block">
		  <ul class="flex items-center gap-6 text-sm">
			...
			<li>
				<a class="text-gray-500 transition hover:text-gray-500/75" href="/favorites"> Favorites </a>
			</li>
			...
			<li>
			  <a class="text-gray-500 transition hover:text-gray-500/75" href="/admin/comments"> Comments </a>
			</li>
		...
		<a class="text-black-600 transition hover:text-gray-500/75 pr-14" href="/">Welcome back {data.user.username} </a>


		<div class="flex items-center justify-center">
		<form action="/logout?/logout" method="POST" class="p-1">
			<button class="block rounded-md bg-teal-600 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-teal-700">Logout</button>
		</form>
		<form action="/logout?/deleteAccount" method="POST" class="p-1">
			<button class="block rounded-md bg-teal-600 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-teal-700">Delete Account</button>
		</form>
	   </div>
...
{#if data.user}
    <main class="flex justify-center items-center p-50">
